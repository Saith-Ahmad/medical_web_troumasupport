    ...
    >
      <div className="flex flex-col justify-center items-start gap-4">
        <div className="flex justify-center items-center gap-4 w-full">
          ...
          <select className="flex-1 px-1 py-0 rounded-md min-h-[60px] border-2 border-gray-200 focus:border-2 focus:border-gray-300 focus:outline-none w-full appearance-none">
            <option value="location1" className="text-gray-800">
              2023/2024
            </option>
            <option value="location1" className="text-gray-800">
              2022/2023
        ...
        <div className="relative w-full bg-white border-2 border-gray-200 shadow-sm px-4 py-3 rounded-lg flex justify-start items-center gap-3">
          ...
          <input
            type="text"
            placeholder="Acute Troma"
            className="focus:outline-none"
          />
        </div>
        <div className="p-3 border-t-2 border-dotted border-gray-300 w-full">
          <p className="para-large text-primary font-semibold">
            Complex Trouma
          </p>
