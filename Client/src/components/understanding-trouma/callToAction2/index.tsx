  ...
  return (
    <div className=" my-16 container px-4">
      <div className="flex flex-col justify-center items-center">
        <h2 className="heading-2 text-center">We are here to help</h2>
        <p className="para-large font-light mt-2 md:px-[230px] text-center">
          If you or a loved one is struggling with trauma, reach out to our
          professionals today for a personalized support plan.
        </p>
