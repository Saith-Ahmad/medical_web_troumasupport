    ...
    <div className="bg-offwhite w-full min-h-[1000px] p-5  flex flex-col justify-start items-start rounded-lg gap-y-3 shadow-xl mb-10">
      <div>
        <h4 className="heading-5 font-bold">
          Refine <span className="text-primary">Your Search</span>
        </h4>
      </div>

      <form className="flex flex-col justify-start items-start rounded-md gap-y-5">
        <label htmlFor="location" className="ms-1 text-gray-700">
          Location
        </label>
        <div className="relative w-full">
          <input
            ...
            className="w-full   pr-10 py-4   rounded-md  px-4 focus:outline-none focus:outline-primary focus:outline-2"
          />
        ...
        <div className="border-t-2 border-t-gray-200 min-h-[120px] pt-5">
          ...
          <select className="mt-2 w-full flex-1 md:mr-2 mb-2 md:mb-0 p-2  rounded-md min-h-[60px]  focus:outline-none focus:border-none appearance-none">
        ...
        <div className=" pt-5 para-medium border-t-2 border-t-gray-200 w-full ">
          ...
          <div className="flex flex-col space-y-2 mt-3">
            <label className="inline-flex items-center">
              <input
                type="checkbox"
                className="form-checkbox text-black accent-black"
              />
