      ...
      <div className="min-h-[100px] bg-white shadow-lg py-3 flex flex-col justify-center p-5 rounded-xl">
        <form className="flex flex-col md:flex-row md:items-center md:justify-between">
          ...
          <motion.select
            ...
            viewport={{ once: true }}
            className="flex-1 md:mr-2 mb-2 md:mb-0 p-2 border border-gray-300 rounded-md min-h-[60px]  focus:border-primary  focus:outline-none focus:border-none focus:ring focus:ring-primary appearance-none"
          >
