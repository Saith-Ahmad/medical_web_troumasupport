...
const HowItWorks = () => {
  return (
    <div className="container">
      <h2 className="text-3xl md:text-[48px] font-prata leading-tight text-center">How<span className="text-primary"> It Works</span></h2>
      <p className="text-center font-light">Learn more about our works</p>
      ...
      className="flex flex-col lg:flex-row justify-between items-center mt-4 space-y-5">
        ...
        <div className="flex flex-col w-full lg:w-[32%] justify-center items-center space-y-2">
            ...
            <h2 className="text-secondary font-semibold">Best Online professional</h2>
        ...
        <div className="flex flex-col w-full lg:w-[32%] justify-center items-center space-y-2">
            <img src={InstantAppointment} alt="Instant Appointment" />
            <h2 className="text-secondary font-semibold">Get Instant Appoitment</h2>
        ...
        <div className="flex flex-col w-full lg:w-[32%] justify-center items-center space-y-2">
            ...
            <h2 className="text-secondary font-semibold">Leave YourFeedback</h2>
